...
Revision ID: de04dda17814
Revises: a37c8f17fbb0
Create Date: 2019-08-15 07:34:13.861875
...
def upgrade():
    ...
    with op.batch_alter_table('paper', schema=None) as batch_op:
        batch_op.add_column(sa.Column('question_order', sa.String(), server_default='[]', nullable=False))
